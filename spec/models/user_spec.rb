...
RSpec.describe User, type: :model do
  ...
  it "create a user with valid image" do
    test_user = User.create(valid_attributes)
    expect(test_user.image).to be_valid
  end

  it "can't create a user with invalid attributes" do
  ...
  it "update a user with valid image" do
    test_user = User.create(valid_attributes)
    test_user.update(update_attributes)
    test_user.reload
    expect(test_user.image).to be_valid
  ...
  it "can't update a user with invalid attributes" do
    test_user = User.create(valid_attributes)
